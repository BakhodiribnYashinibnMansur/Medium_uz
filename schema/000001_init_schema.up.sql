...
post_rated REAL NULL DEFAULT 0.0,
post_vote_count INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS rating_post (
id  SERIAL NOT NULL UNIQUE,
reader_id INTEGER   REFERENCES users(id) ON DELETE CASCADE NOT NULL,
post_id INTEGER REFERENCES post(id) ON DELETE CASCADE NOT NULL,
...
id  SERIAL NOT NULL UNIQUE,
account_id INTEGER   REFERENCES users(id) ON DELETE CASCADE NOT NULL,
follower_id INTEGER   REFERENCES users(id) ON DELETE CASCADE NOT NULL,
follower_data  TIMESTAMP DEFAULT (NOW()),
created_at TIMESTAMP  DEFAULT (NOW()),
updated_at TIMESTAMP NULL,
deleted_at TIMESTAMP NULL
);
